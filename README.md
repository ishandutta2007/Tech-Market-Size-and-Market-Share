...
| **PC Hardware**<br>(Laptops & Desktops) | ~\$220 Billion | - | 1. **Lenovo** (24.0%)<br>2. **HP Inc.** (20.5%)<br>3. **Dell** (15.5%)<br>4. **Apple (Mac)** (9.0%)<br>5. **ASUS** (7.0%)<br>6. **Acer** (6.5%)<br>...<br>**. Microsoft (Surface)** (~1.0%) |
| **Smartphones**<br>(Hardware Devices) | ~\$520 Billion | - | 1. **Apple** (20.0%) *(>45% revenue share)*<br>2. **Samsung** (19.0%)<br>3. **Xiaomi** (14.0%)<br>4. **Transsion** (9.0%)<br>5. **Oppo** (8.5%)<br>6. **Vivo** (7.5%) |
| **B2C E-commerce**<br>(Retail & Consumer Goods) | ~\$2.0 Trillion | ~\$6.3 Trillion | 1. **Alibaba (Taobao/Tmall)** (20.5%)<br>2. **Amazon** (12.5%)<br>3. **PDD Holdings (Temu/Pinduoduo)** (10.5%)<br>4. **JD.com** (8.5%)<br>5. **Shopify (Merchant Ecosystem)** (4.0%) |
| **B2B E-commerce**<br>(Wholesale Procurement) | ~\$500 Billion | ~\$22.0 Trillion | *(Highly Fragmented / EDI dominated)*<br>1. **Alibaba.com** (~1.5%)<br>2. **Amazon Business** (~0.5%)<br>3. **Global Sources** (<0.5%)<br>4. **IndiaMART** (<0.5%) |
| **AI Chips & GPUs**<br>(Data Center & AI Accelerators) | ~\$130 Billion | - | 1. **Nvidia** (86.0%)<br>2. **AMD (Instinct)** (8.0%)<br>3. **Cloud ASICs (TPU/Trainium/MTIA)** (4.0%)<br>4. **Intel (Gaudi)** (2.0%) |
| **General Semiconductors**<br>(Memory, Mobile SoCs & CPUs) | ~\$470 Billion | - | 1. **Samsung Electronics** (13.0%)<br>2. **Intel** (10.0%)<br>3. **SK Hynix** (8.5%)<br>4. **Qualcomm** (7.5%)<br>5. **Broadcom** (7.0%)<br>6. **Micron** (5.0%) |
| **Streaming Video**<br>(SVOD Platforms) | ~\$120 Billion | - | 1. **Netflix** (34.0%)<br>2. **Disney+ / Hulu** (16.0%)<br>3. **Amazon Prime Video** (11.5%)<br>4. **Warner Bros (Max)** (9.0%)<br>5. **Paramount+ / Peacock / Apple TV+** (~4-5% each) |
