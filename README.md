...
| :--- | :--- | :--- | :--- |
| **SaaS**<br>(Enterprise Software) | ~\$488 Billion | - | 1. **Microsoft** (18.0%)<br>2. **Salesforce** (12.5%)<br>3. **SAP** (5.5%)<br>4. **Oracle** (4.5%)<br>5. **Adobe** (4.0%)<br>6. **Intuit** (3.5%)<br>7. **Google (Workspace)** (3.0%)<br>8. **ServiceNow** (2.5%)<br>9. **Workday** (2.0%)<br>10. **Shopify** (1.5%)<br>11. **Atlassian** (1.2%) |
...
| **B2C E-commerce**<br>(Retail & Consumer Goods) | ~\$2.0 Trillion | ~\$6.3 Trillion | 1. **Alibaba (Taobao/Tmall)** (20.5%)<br>2. **Amazon** (12.5%)<br>3. **PDD Holdings (Temu/Pinduoduo)** (10.5%)<br>4. **JD.com** (8.5%)<br>5. **Douyin E-commerce** (5.5%)<br>6. **Meituan** (4.5%)<br>7. **Shopify (Merchant Ecosystem)** (4.0%)<br>8. **Walmart Online** (2.0%)<br>9. **Shopee (Sea Group)** (1.5%)<br>10. **eBay** (1.2%)<br>11. **Mercado Libre** (1.0%) |
| **B2B E-commerce**<br>(Wholesale Procurement) | ~\$500 Billion | ~\$22.0 Trillion | *(Highly fragmented market dominated by legacy offline contracts, EDI, and custom ERP procurement portals.)*<br>1. **Alibaba.com** (~1.5%)<br>2. **W.W. Grainger** (~0.8%)<br>3. **Amazon Business** (~0.5%)<br>4. **Fastenal** (~0.4%)<br>5. **Global Sources** (<0.5%)<br>6. **Made-in-China** (<0.5%)<br>7. **IndiaMART** (<0.5%) |
